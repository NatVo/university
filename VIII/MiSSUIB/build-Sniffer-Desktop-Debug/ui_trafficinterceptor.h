...
public:
    ...
    {
        TrafficInterceptor->setWindowTitle(QApplication::translate("TrafficInterceptor", "Welcome!", Q_NULLPTR));
        pushButton->setText(QApplication::translate("TrafficInterceptor", "Ok", Q_NULLPTR));
    } // retranslateUi
